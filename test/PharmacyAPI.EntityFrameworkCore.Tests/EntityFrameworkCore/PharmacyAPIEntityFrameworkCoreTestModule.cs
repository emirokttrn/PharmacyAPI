...
[DependsOn(
    typeof(PharmacyAPIApplicationTestModule),
    typeof(PharmacyAPIEntityFrameworkCoreModule),
    typeof(AbpEntityFrameworkCoreSqliteModule)
    )]
public class PharmacyAPIEntityFrameworkCoreTestModule : AbpModule
{
    ...
    private void ConfigureInMemorySqlite(IServiceCollection services)
    {
        ...
        _database.CreateTables(
            new PharmacyAPIDbContext(new DbContextOptionsBuilder<PharmacyAPIDbContext>().UseSqlite(_database.ConnectionString).Options));
